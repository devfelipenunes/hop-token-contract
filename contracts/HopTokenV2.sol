...
contract HopToken is ReentrancyGuard {
    ...
    function createNFTBeer(
        ...
        ERC721(nftBeer).transferFrom(msg.sender, address(this), tokenId);
    ...
    function createBeerSale(
        ...
        ERC721(nftBeer).transferFrom(address(this), msg.sender, tokenId);
    ...
    function createNFTRecipe(
        ...
        ERC1155(nftRecipe).safeTransferFrom(
            msg.sender,
            address(this),
            tokenId,
            1,
